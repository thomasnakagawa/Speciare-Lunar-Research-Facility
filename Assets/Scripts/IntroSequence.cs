...
public class IntroSequence : MonoBehaviour
{
    ...
    public void StartIntro()
    {
        SceneUtils.FindComponentInScene<DialogBox>().ShowDialog(new DialogLine[]
        {
            ...
            new DialogLine("", "These diseases caused immense plagues and devastated the earths population"),
            new DialogLine("", "After several years of the epidemic, medical researchers discovered a cure"),
            new DialogLine("", "This cure requires intense galactic cosmic radiation to manufacture, meaning it can only be made outside of the earths atmosphere"),
            ...
            new DialogLine("", "In the following years, the diseases stopped on earth"),
